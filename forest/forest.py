...
class RandomForest:
    def __init__(self, num_ID3: int, num_SVM: int, id3_max_depth: int = 10, svm_regularization: float = 1.0, svm_kernel: str = 'rbf'):
        self.num_ID3 = num_ID3
        self.num_SVM = num_SVM
        self.svm_regularization = svm_regularization
        self.svm_kernel = svm_kernel
        self.id3_max_depth = id3_max_depth
        self.ID3_models = [ID3(self.id3_max_depth) for _ in range(num_ID3)]
